...
import static com.edu.eci.ieti.laboratorio.DTO.options.Constants.COOKIE_NAME;
        ...
        if (HttpMethod.OPTIONS.name().equals(request.getMethod())){
            ...
            try{
                Optional<Cookie> optionalCookie = (request.getCookies() != null ?
                        Arrays.stream( request.getCookies() ).filter(cookie -> Objects.equals( cookie.getName(), COOKIE_NAME ) ).findFirst() :
                        Optional.empty());
